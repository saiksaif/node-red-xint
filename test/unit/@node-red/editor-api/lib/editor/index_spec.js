    ...
    describe("enables the editor", function() {
        ...
        it('serves the editor', function(done) {
            ...
            .end(function(err,res) {
                ...
                // Index page should probably mention XintSolutions somewhere
                res.text.indexOf("XintSolutions").should.not.eql(-1);
                done();
            });
        });
        ...
        it('warns if runtime not started', function(done) {
            ...
            .end(function(err,res) {
                ...
                errors[0].should.eql("XintSolutions runtime not started");
                done();
            });
        });
